    ...
    <div className='works'>
        ...
        <div className='projects'>
            ...
            <div className='projectRight'>
                <Link to = 'https://github.com/Kithkav/petCare' className='repo'>Access GitHub repository</Link>
        ...
        <div className='project2'>
            ...
            <div className='projectRight'>
                <Link to = 'https://github.com/Kithkav/Food-App' className='repo'>Access GitHub repository</Link>
